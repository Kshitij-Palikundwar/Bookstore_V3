...
public class IdpProjectApplication {

	public static void main(String[] args) throws NumberFormatException, IOException {
		log.info("START");
		ConfigurableApplicationContext ctx = SpringApplication.run(IdpProjectApplication.class, args);
		
		UserService service=ctx.getBean(UserServiceImpl.class);
